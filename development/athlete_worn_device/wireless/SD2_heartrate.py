...
# used for turning on temp sensor and heartbeat monitoring
PERIPHERAL_CONTROL = GPIO_12

MONITOR_STATION_ADDRESS = '\x09\x9F\xF8'
...
def startup():
    ...
    global heartRate, PERIPHERAL_CONTROL, MONITOR_STATION_ADDRESS, INITIAL_TIMEOUT
    ...
    start_heart_rate_and_temp_sensing()
    
def start_heart_rate_and_temp_sensing():
    i2cInit(True)
